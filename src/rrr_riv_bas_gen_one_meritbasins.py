#!/usr/bin/env python
#*******************************************************************************
#rrr_riv_bas_gen_one_meritbasins.py
#*******************************************************************************

#Purpose:
#Given a river shapefile from MERIT Basins, a connectivity table and associated 
...
for JS_riv_bas in range(IS_riv_bas):
     mer_riv_prp=mer_riv_lay[JS_riv_bas]['properties']
     IV_riv_bas_id.append(int(mer_riv_prp[YV_riv_id]))
