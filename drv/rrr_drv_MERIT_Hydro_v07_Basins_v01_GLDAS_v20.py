...
class RRR(object):
     ...
     def set_paths(self):
          ...
          #--------------------------------------------------------------------- 
          self.lsm_tmp = f'GLDAS_{self.lsm_mod}_{self.lsm_stp}_{self.yyyy_mm}_utc_tmp.nc4'
          self.lsm_ncf = f'GLDAS_{self.lsm_mod}_{self.lsm_stp}_{self.yyyy_mm}_utc.nc4'
